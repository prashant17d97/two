...
/**
 * Renders an email form component designed to collect user email addresses for password reset.
 * This form includes input validation for email addresses and triggers a submission handler when the form is submitted.
 *
 * @param {Object} props - The props object for the EmailForm component.
 * @param {boolean} props.isSubmitting - A boolean indicating whether the form is currently in a submitting state.
 * @param {Function} props.onSubmit - A callback function to handle the form submission, invoked with the valid email address.
 *
 * @return {JSX.Element} The rendered EmailForm component.
 */
export default function EmailForm({ isSubmitting, onSubmit }) {
    ...
    >
      ...
      >
        ...
        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          <path d="M1.5 6.75A2.25 2.25 0 013.75 4.5h16.5a2.25 2.25 0 012.25 2.25v10.5A2.25 2.25 0 0120.25 19.5H3.75A2.25 2.25 0 011.5 17.25V6.75zM3 7.5l8.61 5.26a1.5 1.5 0 001.58 0L21 7.5" />
        </svg>
      </button>
    </form>
  );
